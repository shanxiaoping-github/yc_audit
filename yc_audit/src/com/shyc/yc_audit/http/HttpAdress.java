...
public class HttpAdress {
	...
	public static final String CONTRACT_ALREADY_LIST_URL = "getCompleteContractList.action";
	public static final String CONTRACT_ALREADY_LIST_ACTION = "getCompleteContractList";
